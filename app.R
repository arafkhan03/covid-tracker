...
basemap = leaflet(plot_map) %>% 
  ...
  addLegend("bottomleft", pal = cv_pal, values = ~cv_large_countries$deaths_per_million,
  ...
  navbarPage(theme = shinytheme("superhero"), collapsible = TRUE,
             ...
             div(class="outer",
                          ...
                          div(class='info_box',
                              div(class='info_item',
                                h4("Cases: "),
                                h6(textOutput("reactive_case_count"))
                              ),
                              div(class='info_item',
                                  h4("Deaths: "),
                                  h6(textOutput("reactive_death_count"))
                              ),
                              div(class='info_item',
                                  h4("Date: "),
                                  h6(textOutput("clean_date_reactive"))
                              ),
                              div(class='info_item',
                                  h4("Effected Countries: "),
                                  h6(textOutput("reactive_country_count")),
                              )),
                          leafletOutput("mymap", width="100%", height="83%"),
                          
                          absolutePanel(id = "controls", class = "panel panel-default",
                                        top = 180, left = 55, width = 250, fixed=TRUE,
